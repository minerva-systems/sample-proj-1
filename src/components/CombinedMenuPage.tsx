...
export function CombinedMenuPage() {
    ...
    sushi: {
      ...
      items: [
        ...
        },
        {
          ...
          price: "",
          description:
            "Crispy salmon skin, cucumber, scallion, masago topped with unagi sauce",
        },
        {
          name: "Philadelphia Roll",
          price: "",
          description:
            "Smoked salmon, cream cheese, cucumber topped with avocado",
        },
        {
          name: "Alaska Roll",
          price: "",
          description:
            "Salmon, avocado, cucumber topped with masago & scallion",
        },
        {
          name: "Spicy Tuna Roll",
          price: "",
          description: "Spicy tuna, cucumber, masago topped with unagi sauce",
        },
        {
          name: "Spicy Salmon Roll",
          price: "",
          description:
            "Spicy salmon, cucumber, masago topped with unagi sauce",
        },
        {
          name: "Tuna Roll",
          price: "",
          description: "Tuna, cucumber, masago topped with unagi sauce",
        },
        {
          name: "Salmon Roll",
          price: "",
          description: "Salmon, cucumber, masago topped with unagi sauce",
        },
        {
          name: "California Roll",
          price: "",
          description: "Crab meat, avocado, cucumber, masago",
        },
        {
          name: "Cucumber Roll",
          price: "",
        ...
        {
          name: "Specialty Roll (特製ロール)",
          price: "",
          description: "",
        },
        {
          name: "Harumi Special Roll",
          price: "",
          description:
            "Crab meat, avocado inside, topped with assorted raw fish, masago & scallion",
        },
  ...
  // Remove AYCE items from sushi section
  const sushiItemsWithoutAyce = menuData.sushi.items.filter(
    (item) =>
      ![
        "AYCE Pricing",
        "Dinner AYCE",
  ...
  const menuSections = [
    { key: "starters", ...menuData.starters },
    {
      key: "sushi",
      ...menuData.sushi,
      items: sushiItemsWithoutAyce,
    },
    { key: "drinks", ...menuData.drinks },
  ];
          ...
          <div className="flex justify-center gap-4 md:gap-8 py-4">
            {menuSections.map((section) => (
              <a
                ...
                className="text-lg font-semibold text-gray-700 hover:text-rose-600 transition-colors px-4 py-2 relative group"
              >
                {section.title}
          ...
          <div className="space-y-6">
            {ayceItems.map((item, itemIndex) => (
              ...
              >
                ...
                {item.price ? (
                  <div className="text-rose-600 whitespace-nowrap font-semibold text-lg">
                    {item.price}
                  </div>
                ) : null}
              </div>
